...
<section class="px-4 max-w-3xl text-center">
	...
	<div class="flex flex-wrap justify-center gap-6">
		...
		<div class="flex flex-col items-center text-center w-1/3 role-moderator text-role-moderator role-board text-role-board">
			<img class="w-20 md:w-28 bg-white lg:w-[120px] aspect-square rounded-full object-cover mb-2" src="https://raw.githubusercontent.com/brisbanesocialchess/brisbanesocialchess.github.io/main/frontend/assets/images/github-octocat.svg" alt="Jasper avatar" />
